        ...
        <div className="simulador">
          ...
          {(user.role == "admin" || user.role == "read-write") && (
            <div className="buttons">
              <button onClick={Delete} className="delete_button">
                <FaTrash size={20} />
              </button>
            </div>
          )}
          <div className="text">
            ...
            {activos[0] != null && (
              <>
                <h4>
                  No. Activo Fijo y Ubicación(Cualquier clic en "Ok" o
                  "Eliminar" será irreversible)
                </h4>
                ...
                <ol>
                  {inputList.map((activo, index) => {
                    return (
                      <li key={index}>
                        <div className="agrouped_container">
                          AF/
                          <input
                            className="input"
                            type="text"
                            placeholder={
                              activo[0] == null || activo[0] == ""
                                ? "Sin AF"
                                : activo[0]
                            }
                            onChange={(e) => {
                        ...
                        <button
                          className="ok"
                          onClick={(event) =>
                            handleInputChange(af, index, ubicacion)
                          }
                        >
                          Ok
                        </button>
